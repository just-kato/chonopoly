...
export default function Sidebar({ chapters, activeId, onSelect, progress, completedCount, totalCount }: Props) {
  ...
  return (
    <div className="w-64 h-full bg-[#18181c] border-r border-[#2e2e38] flex flex-col">
      <div className="px-5 py-5 border-b border-[#2e2e38]">
