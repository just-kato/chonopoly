  ...
  return (
    <div className="flex flex-col h-full bg-[#0f0f11] text-[#e8e6df] font-sans">
      ...
      <div className="sticky top-0 z-10 shrink-0">
        <div className="bg-[#18181c] border-b border-[#2e2e38] px-6 py-6 flex items-start gap-4">
          <span className="bg-amber-400 text-black font-mono text-[11px] font-medium px-2.5 py-1 rounded mt-1 shrink-0 tracking-widest">
            GA EXAM PREP
          </span>
          <div>
            ...
            <p className="text-[#7a7870] text-xs mt-0.5">{chapter.subtitle}</p>
          </div>
        </div>
        <div className="flex gap-1 px-6 border-b border-[#2e2e38] overflow-x-auto bg-[#0f0f11]">
          {TABS.map((t) => (
            <button
              key={t}
              onClick={() => setTab(t)}
      ...
      <div className={`${tab === "Resources" ? "" : "max-w-3xl"} mx-auto px-6 py-8 pb-16`}>

        {/* OVERVIEW */}
        {tab === "Overview" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Chapter Overview</h2>
            ...
            <ul className="flex flex-col gap-3 mb-7">
              {chapter.objectives.map((obj, i) => (
                <li key={i} className="flex gap-3 items-start bg-[#18181c] border border-[#2e2e38] rounded-lg px-4 py-3.5 text-sm">
                  <span className="bg-amber-400 text-black font-mono text-[11px] font-medium px-2 py-0.5 rounded flex-shrink-0 mt-0.5">
                    OBJ {i + 1}
                  </span>
                  {obj}
                </li>
            ...
            <div className="bg-amber-500/8 border-l-3 border-amber-500 border-l-2 pl-4 py-3 rounded-r-lg mb-6 text-sm text-[#e8e6df]">
        ...
        {tab === "Course Content" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Course Content</h2>
            ...
            {chapter.courseContent ? (
              <div className="bg-[#18181c] border border-[#2e2e38] rounded-xl p-6 max-h-[60vh] overflow-y-auto">
        ...
        {tab === "Core Concepts" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Core Concepts</h2>
        ...
        {tab === "Key Terms" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Key Terms</h2>
        ...
        {tab === "Practice Questions" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Practice Questions</h2>
        ...
        {tab === "Quick Reference" && (
          <div>
            <h2 className="font-serif text-2xl font-bold text-white mb-1">Quick Reference</h2>
